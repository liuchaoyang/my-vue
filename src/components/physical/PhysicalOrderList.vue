    ...
    <div>
        ...
        <el-dialog title="订单处理状态设置" :visible.sync="overFormVisible">
            <el-form :model="form">
                ...
                <el-form-item label="理疗项目" :label-width="formLabelWidth">
    ...
    export default {
        ...
        methods: {
            overSave: function () {
                ...
                instance.post('/admin/physical/order/over', qs.stringify(this.form))
                    .then(response => {
            ...
            refreshTable: function (p, ps) {
                axios
                    .get('https://www.yiyadr.com/my-doctor/admin/physical/order/list_all?page=' + p + '&pageSize=' + ps)
                    // .get('http://localhost:8086/admin/physical/order/list_all?page=' + p + '&pageSize=' + ps)
                    .then(response => {
