<template>
    <div>
        ...
        <el-table :data="tableData" border >
            <el-table-column prop="id" label="理疗编号"></el-table-column>
            <el-table-column prop="name" label="理疗名称" ></el-table-column>
            <el-table-column prop="summary" label="理疗简介" ></el-table-column>
        ...
        <el-dialog title="理疗编辑" :visible.sync="addFormVisible">
            <el-form :model="form">
                ...
                <el-form-item label="理疗简介" :label-width="formLabelWidth">
                ...
                <el-form-item label="理疗医生" :label-width="formLabelWidth">
